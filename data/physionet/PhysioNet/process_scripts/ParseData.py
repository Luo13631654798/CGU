...
df_outcomes_a = pd.read_csv('../raw/Outcomes-a.txt', sep=",", header=0,
...
# merge dataframes
arr_outcomes = np.concatenate([arr_outcomes_a], axis=0)
...
param_list_a = extract_unq_params('../raw/set-a/')
