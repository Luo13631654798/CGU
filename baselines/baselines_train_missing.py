...
parser.add_argument('--dataset', type=str, default='P19', choices=['P12', 'P19', 'PAM', 'physionet', 'mimic3']) #
...
parser.add_argument('--baseline', type=str, default='SEFT', choices=['Transformer', 'GRUD', 'SEFT', 'mTAND',
